...
class MyHomePage extends StatefulWidget {
  ...
  // This widget is the configuration for the State object.
  ...
  // This widget is stateful, meaning it has a State object (defined below)
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          // The main axis here is the vertical axis because Columns are
          // vertical (the cross axis would be horizontal).
          mainAxisAlignment: .center,
          children: [
            const Text(
              'push me:',style: TextStyle(fontSize:20),
            ),
            Text(
              '$_counter',
